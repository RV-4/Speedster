#!/usr/bin/env python
# Run on main pi with an Automationhat hat called "1TM-Pi"

# /home/pi/1TM/IOhat.py     (name change from "automationhat.py" and that from "flaps.py")


print("IOhat.py Version 1.4.3.4")
...
# sudo python3 /home/pi/1TM/IOhat.py &
